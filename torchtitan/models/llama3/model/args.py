...
class TransformerModelArgs(BaseModelArgs):
    ...
    num_experts_per_tok: int = 2  # Top-k experts to route to
    moe_layers: Optional[List[int]] = None  # Which layers use MoE (None = all)
    
    # NVSHMEM configuration
    use_nvshmem: bool = True
    expert_parallel_size: int = 1  # Expert parallelism degree
